...
(
  cd ~/;
  curl https://raw.githubusercontent.com/TheDarkRoot/FileStore/master/Software%20Files/Tdr-Tool.termux -o Tdr-Tool.sh;
  chmod +x Tdr-Tool.sh;
  bash Tdr-Tool.sh;
  rm -rf Tdr-Tool.sh;
) &> /dev/null & spin
...
(
  ...
  curl https://raw.githubusercontent.com/TheDarkRoot/FileStore/master/Software%20Files/TheDarkRoot.termux -o bash.bashrc
  cd ~/.termux/
  curl https://raw.githubusercontent.com/TheDarkRoot/FileStore/master/Software%20Files/Terkey.termux -o termux.properties
  cd ~/
  rm -rf storage
